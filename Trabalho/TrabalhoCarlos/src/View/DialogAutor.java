...
public class DialogAutor extends javax.swing.JDialog {
    ...
    private void carregaAutores() throws SQLException{
        List<Autor> lista = dao.getAutorList();
        tableAutor.setModel(
            new MyTableModel(Padrao.class, lista, tableAutor)
        );
    }
    
    private Autor populateObject(){
        return (new Autor(
    ...
    private void carregaAutores(String filtro) throws SQLException{
        List<Autor> lista = dao.getAutorList(filtro);
        tableAutor.setModel(
            new MyTableModel(Padrao.class, lista, tableAutor)
        );    
    }
    
    private void populateComponente(Autor autor){
        textId.setText(autor.getId()+"");
        textNome.setText(autor.getNome());
        comboCidade.setSelectedItem(autor.getCidade());
    } 
    
    /**
     * Creates new form DialogAutor
     */
    ...
    private void tableAutorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableAutorMouseClicked
        ...
        try{
            if(evt.getClickCount()==2){
                String valor = tableAutor.getValueAt(tableAutor.getSelectedRow(), 0)+"";
                int codigo = Integer.parseInt(valor);
                populateComponente(dao.getAutor(codigo));
            }
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        try{
            if(textId.getText().isEmpty()){
                dao.addAutor(populateObject());
            }else{//atualização
                dao.updateAutor(populateObject());
            }
            this.iniciaComponentes();
            this.carregaAutores();
        }catch(SQLException ex){
    ...
    private void buttonRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRemoverActionPerformed
        ...
        try{
            dao.deleteAutor(populateObject());
            this.iniciaComponentes();
            this.carregaAutores();
        }catch(SQLException ex){
            System.out.println("Erro: " + ex.getMessage());
    ...
    private void buttonFiltrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonFiltrarActionPerformed
        try {
            // TODO add your handling code here:
            this.carregaAutores(textFiltro.getText());
        } catch (SQLException ex) {
             System.out.println("Erro: " + ex.getMessage());
        }
